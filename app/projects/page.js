...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A web application that allows teachers to upload grades of student. Grades are accumulated into reports which can be generated by the school Admin and the parents of students.",
