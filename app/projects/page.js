...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A web application that allows teachers to upload grades of student. Reports can be generated by the school Admin and the parents of students.",
      icon: <ClipboardList className="w-16 h-16 mx-auto text-primary" />,
      tags: ["fullstack"],
      tech: ["React", "Tailwind", "Sequelize", "Node.js", "Express", "MySQL"],
      liveLink: "#",
    ...
    },
    {
      title: "Quiz App",
      description:
        "A mobile quiz application built with React Native and Expo. Users can log in, select quiz categories, answer timed questions, and track their scores.",
      icon: <MessageCircle className="w-16 h-16 mx-auto text-primary" />,
      tags: ["fullstack"],
      tech: ["React Native", "Expo", "Node.js", "Express", "MySQL"],
      liveLink: "#",
      githubLink: "https://github.com/BCEESAY10/quiz-app",
      isPrivate: false,
      screenshots: [
        "https://placehold.co/400x800/667eea/ffffff?text=Login+Screen",
        "https://placehold.co/400x800/667eea/ffffff?text=Category+Selection",
        "https://placehold.co/400x800/667eea/ffffff?text=Quiz+Screen",
        "https://placehold.co/400x800/667eea/ffffff?text=Score+Dashboard",
      ],
    },
  ];
