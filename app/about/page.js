  ...
  const qualities = [
    {
      ...
      description:
        "Passionate about crafting clean, efficient code and staying current with modern web technologies.",
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "Fast Learner",
      description:
        "Quickly adapt to new technologies and methodologies, transforming challenges into opportunities for growth.",
    },
    {
      icon: <Rocket className="w-6 h-6" />,
      title: "Problem Solver",
      description:
        "Approach challenges with analytical thinking and creative solutions, always seeking optimal outcomes.",
    },
    {
      icon: <Clock className="w-6 h-6" />,
      title: "Pressure Handler",
      description:
        "Thrive in fast-paced environments, maintaining quality and efficiency under demanding circumstances.",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
              Hello! I'm Bamfa Ceesay, a trained Product Engineer and an
              Aspiring Software developer. I earned a BSc in computer science
              from the University of The Gambia in 2025. My journey in tech is
              driven by a deep fascination with creating beautiful, intuitive
        ...
        <motion.div
          ...
          {qualities.map((quality, index) => (
            <motion.div
              ...
              <div className="text-primary mb-4">{quality.icon}</div>
